...
<head>
    ...
    <title>Pharmacy System - Supplier</title>
    <style>
        body {
        ...
        /* Specific styles for the Supplier page content */
        .supplier-actions {
            margin-bottom: 20px;
            display: flex;
            gap: 10px;
        ...
        .supplier-actions input[type="text"] {
            padding: 8px;
        ...
        .supplier-list tbody td a {
            text-decoration: none;
            color: #007bff;
            margin-right: 5px;
        }

        .supplier-list tbody td button {
            padding: 5px 10px;
        ...
        .supplier-list tbody td button:hover {
...
<body>
    ...
    <main>
        ...
        <section class="supplier-actions">
            <button onclick="location.href='Supplier-form.html'">Add New Supplier</button>
            ...
            <table>
                ...
                if (mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td><button onclick=\"location.href='delsupplier.php?id=" . $row['supplier_id'] . "'\">Delete</button></td>";
                        echo "</tr>";
                    }
                } else {
    ...
    <script>
        ...
        // JavaScript for Supplier page functionality would go here
    </script>
</body>
</html>
