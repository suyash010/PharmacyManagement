...
<head>
    ...
    <title>Pharmacy System - Inventory</title>
    <style>
        body {
        ...
        /* Specific styles for the Inventory page content */
        .inventory-actions {
            margin-bottom: 20px;
            display: flex;
            gap: 10px;
        ...
        .inventory-list tbody td a {
            text-decoration: none;
            color: #007bff;
            margin-right: 5px;
        }

        .inventory-list tbody td button {
            padding: 5px 10px;
        ...
        .inventory-list tbody td button:hover {
...
<body>
    ...
    <main>
        ...
        <section class="inventory-actions">
            <button onclick="location.href='Inventory-form.html'">Add New Item</button>
            ...
            <table>
                ...
                if (mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td><button onclick=\"location.href='delitem.php?id=" . $row['inventory_id'] . "'\">Delete</button></td>";
                        echo "</tr>";
                    }
                } else {
    ...
    <script>
        ...
        // JavaScript for Inventory page functionality would go here
    </script>
</body>
</html>
